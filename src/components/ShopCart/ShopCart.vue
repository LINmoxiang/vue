    ...
    <div class="shopcart">
      <div class="content">
        ...
        <div class="content-right">
          <div class="pay" :class="payType">{{payText}}</div>
        </div>
      </div>
      <transition name="showList">
        <div class="shopcart-list" v-show="listShow">
          ...
          <div class="list-content" ref="cartF">
            <ul>
...
export default {
  ...
  computed: {
    ...
    listShow() {
      ...
      if (this.isShow) {
        this.$nextTick(() => {
          //判断this.show是否存在(判断是否已创建过scroll)
          if (!this.scroll) {
            this.scroll = new BScroll(this.$refs.cartF, {
              click: true
            });
          } else {
            this.scroll.refresh();

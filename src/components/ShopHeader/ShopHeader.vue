<template>
  <div class="shop-header">
    <nav class="shop-nav" :style="{backgroundImage:`url(${info.bgImg})`}">
      <a class="back">
        <i class="iconfont icon-jiantou2" @click="$router.replace('/msite')" />
      </a>
    </nav>
    <div class="shop-content">
      <img :src="info.avatar" class="content-image" />
      <div class="header-content">
        <h2 class="content-title" @click="isShowShop = true">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isShowActivity = true">
      <div class="discounts-left">
        <div class="activity" :class="info.supports[0].type">
          <span class="content-tag">
